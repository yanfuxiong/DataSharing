...
public:
    ...
    void refreshCachedMonitorData();
    static bool delayInEventLoop(int msValue);

    static bool getCustomerThemeCode(HANDLE hPhysicalMonitor, uint32_t &themeCode);
    ...
    static bool monitorHandleIsValid(HANDLE hMonitor);
