...
Q_SIGNALS:
    ...
    void updateOptRecordStatus(const QByteArray &hashID, int optStatus);
    ...
    void updateCurrentMenuPosData();
    void showOpenSourceLicenseMenu();
    void modifyDefaulutDownloadPath();
    void bugReport();
