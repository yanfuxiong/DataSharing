...
public class DeviceAdapter extends RecyclerView.Adapter<DeviceAdapter.DeviceViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DeviceViewHolder holder, int position) {
        ...
        if (position == selectedPosition) {
            holder.deviceIcon.setBackgroundResource(R.drawable.selected_border);
        } else {
            holder.deviceIcon.setBackgroundResource(0);
        }
        if (mOnItemClickListener != null) {
            ...
            holder.deviceIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mOnItemClickListener.onItemClick(holder.deviceName, selectedPosition); // 2
                }
            });
        }
