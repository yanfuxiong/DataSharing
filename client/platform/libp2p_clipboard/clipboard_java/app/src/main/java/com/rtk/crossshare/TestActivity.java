...
public class TestActivity extends Activity implements View.OnClickListener  {
    ...
    TextView textView_name, textView_size, mConnCountView, mFileConnCountView, mConnectionsView,
            mMyConnectionView, mSwVersionView,mDiasIDView,file_recored_back_icon;
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            myService.setCallback(new FloatClipboardService.DataCallback() {
                ...
                public void sendFileListinfo(String ip,String id,String devicename, String currentFileName, long sentFileCnt, long totalFileCnt, long currentFileSize, long totalSize, long sentSize,long percentage,List<String> filePathList,long timestamp) {
                    ...
                    deviceid=id;
                    currenttimestamp= timestamp;
                    String path = currentFileName.substring(58);
                    ...
                    if(hasSlash){
                        ...
                        for (String filePath : filePathList) {
                            ...
                            String filepath = filePath.substring(58);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_SEND.equals(action) || booleanValue) {
            ...
            Button qrbutton = (Button)findViewById(R.id.buttqr_view);
            qrbutton.setOnClickListener(this);
            mDiasIDView = (TextView)findViewById(R.id.dias_view);
            file_recored_back_icon = (TextView)findViewById(R.id.file_recored_back_icon);
...
//    }
    ...
    private void showScanQrCodesButtonIfNeeded() {
        ...
        if (qrbutton != null && diasIdTitle != null && diasId != null) {
...
//格式化小数
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if(booleanValue) {
            ...
            recyclerView2.setLayoutManager(new LinearLayoutManager(this));
            recyclerView2.setItemAnimator(null);
            adapter = new FileTransferAdapter(fileTransferList, new FileTransferAdapter.OnItemClickListener() {
                @Override
                public void onDeleteClick(int position) {

                    Log.i("GoLog","onDeleteClick");
                ...
                public void onCancelClick(boolean isallfile, String filename) {
                    if(isallfile){
                        cancel_transfers(mContext,null,true);
                    }else{
                        cancel_transfers(mContext,filename,false);
                    }
                }
            ...
            Log.d(TAG, "filesize=" + filesize);
            Log.d("GoLog", "filecount===" + filecount);
...
//    }
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.file_page_back_icon){
            file_page_back_icon = (TextView)findViewById(R.id.file_page_back_icon);
    ...
    public void findviewfilemain(){
        file_recored_back_icon = (TextView)findViewById(R.id.file_page_back_icon);
        file_recored_back_icon.setOnClickListener(this);
