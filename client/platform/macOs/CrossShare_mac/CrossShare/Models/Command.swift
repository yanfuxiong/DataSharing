...
enum Command: UInt8 {
    ...
    case DDCCI_CrossShare_CMD_GET_MAC_1 = 0xE1 // read only
    case DDCCI_CrossShare_CMD_GET_MAC_2 = 0xE2 // read only
    case DDCCI_CrossShare_CMD_AUTH_DEVICE = 0xE0 // do set then get
    case DDCCI_CrossShare_CMD_GET_TV_SRC = 0xE3 // read only
    case DDCCI_CrossShare_CMD_SET_DESKTOP_RESOLUTION_W = 0xE4 // write only
    case DDCCI_CrossShare_CMD_SET_DESKTOP_RESOLUTION_H = 0xE5 // write only
    case DDCCI_CrossShare_CMD_SET_CURSOR_POSITION_X = 0xE6 // write only
    case DDCCI_CrossShare_CMD_SET_CURSOR_POSITION_Y = 0xE7 // write only
    case DDCCI_CrossShare_CMD_GET_CUSTOMIZED_THEME = 0xE8 // read only
...
//    case audioSpeakerVolume = 0xE0
    ...
    // case colorPresetC = 0xE0  // Removed: 0xE0 now used for audioSpeakerVolume
